...
(
  node["tourism"~"museum|attraction|gallery|theme_park|viewpoint|zoo|aquarium"](34.6,135.4,34.8,135.6);
  way["tourism"~"museum|attraction|gallery|theme_park|viewpoint|zoo|aquarium"](34.6,135.4,34.8,135.6);
  relation["tourism"~"museum|attraction|gallery|theme_park|viewpoint|zoo|aquarium"](34.6,135.4,34.8,135.6);
);
out body;
>;
out skel qt;
...
output_path = 'data/raw/osm_osaka_raw.csv'
