...
(
  node["tourism"~"museum|attraction|gallery|theme_park|viewpoint|zoo|aquarium"](35.6,139.6,35.8,139.9);
  way["tourism"~"museum|attraction|gallery|theme_park|viewpoint|zoo|aquarium"](35.6,139.6,35.8,139.9);
  relation["tourism"~"museum|attraction|gallery|theme_park|viewpoint|zoo|aquarium"](35.6,139.6,35.8,139.9);
);
out body;
>;
out skel qt;
...
output_path = 'data/raw/osm_tokyo_raw.csv'
